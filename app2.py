...
result_private = pd.read_csv('result_private_apartment.csv')
# Define floor area ranges
floor_area_ranges = {
    "< 600 sqft": (0, 600),
...
app2.layout = html.Div([
    html.H1("Apartment and Condominium Resale Gain/Loss Dashboard", style={"textAlign": "center"}),
...
if __name__ == "__main__":
    app2.run_server(port=8053, debug=True)